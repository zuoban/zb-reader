    ...
    return (
      <div className="animate-reader-fade-up relative overflow-hidden rounded-2xl border border-border/65 bg-card/76 px-5 py-10 text-center shadow-[0_24px_58px_-42px_color-mix(in_oklab,var(--foreground)_38%,transparent)] backdrop-blur-2xl sm:px-10 sm:py-14">
        ...
        <div className="relative flex flex-col items-center justify-center">
          <div className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-border/60 bg-background/60 px-3 py-1 text-[11px] font-medium text-muted-foreground sm:mb-4 sm:text-xs">
            <Sparkles className="h-3.5 w-3.5 text-[color:var(--cta)]" />
            <span>阅读空间待点亮</span>
          </div>
          <div className="flex h-16 w-16 items-center justify-center rounded-xl bg-muted text-foreground/80 ring-1 ring-border/60 sm:h-18 sm:w-18">
          ...
          <div className="mt-5 flex items-center gap-2 rounded-lg border border-border/60 bg-background/72 px-3 py-2 text-[11px] text-muted-foreground sm:mt-6 sm:text-xs">
