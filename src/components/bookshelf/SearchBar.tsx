  ...
  return (
    <div className={`relative flex items-center ${className}`}>
      ...
      <Input
        ...
        className="h-10 rounded-xl border-white/20 bg-white/40 pl-9 pr-9 text-sm shadow-sm transition-all focus:border-[color:var(--cta)]/50 focus:bg-white/70 focus:shadow-md focus:ring-0 dark:border-white/10 dark:bg-white/5 dark:focus:bg-white/10"
      />
      {query && (
        <button
          type="button"
